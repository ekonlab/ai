...
control + option + I for generating r chunks in rmarkdown.
...
We’ll estimate two additional models with the same resamples. First, the previous linear regression model, using the pre-processing defined in the ames_rec recipe, is resampled:
